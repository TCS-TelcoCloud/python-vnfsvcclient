...
"""
Command-line interface to the vnfsvc APIs
"""
...
from vnfsvcclient.common import clientmanager
from vnfsvcclient.common import exceptions as exc
...
COMMAND_V2 = {
    'service-create': service.CreateService,
    'service-delete': service.DeleteService,
    'service-list': service.ListService,
    'service-show': service.ShowService,
}

COMMANDS = {'1.0': COMMAND_V2}
...
class VNFSvcShell(app.App):
    ...
    def __init__(self, apiversion):
        super(VNFSvcShell, self).__init__(
            description=__doc__.strip(),
            version=VERSION,
            command_manager=commandmanager.CommandManager('vnfsvc.cli'), )
    ...
    def initialize_app(self, argv):
        ...
        * validate authentication info
        ...
        super(VNFSvcShell, self).initialize_app(argv)

        self.api_version = {'vnfservice': self.api_version}
...
def main(argv=sys.argv[1:]):
    try:
        return VNFSvcShell(vnfsvc_API_VERSION).run(map(strutils.safe_decode,
                                                         argv))
    except exc.VNFSvcClientException:
        return 1
